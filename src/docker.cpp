 ...
 * Containers
 */
JSON_DOCUMENT Docker::list_containers(bool all, int limit,
...
JSON_DOCUMENT Docker::logs_container(const std::string &container_id,
                                     bool follow, bool o_stdout, bool o_stderr,
...
JSON_DOCUMENT Docker::create_container(const JSON_DOCUMENT &parameters,
...
JSON_DOCUMENT Docker::stop_container(const std::string &container_id,
                                     int delay) {
...
JSON_DOCUMENT Docker::kill_container(const std::string &container_id,
                                     int signal) {
...
JSON_DOCUMENT Docker::delete_container(const std::string &container_id, bool v,
                                       bool force) {
...
JSON_DOCUMENT Docker::restart_container(const std::string &container_id,
                                        int delay) {
...
JSON_DOCUMENT Docker::attach_to_container(const std::string &container_id,
                                          bool logs, bool stream, bool o_stdin,
...
JSON_DOCUMENT Docker::requestAndParseJson(Method method,
                                          const std::string &path,
                                          unsigned success_code,
                                          const JSON_DOCUMENT &param) {
  auto result_obj = requestAndParse(method, path, success_code, param, true);
  bool result =
      (result_obj.HasMember("success") && result_obj["success"].IsBool() &&
...
JSON_DOCUMENT Docker::exec(const JSON_DOCUMENT &createParameters,
  ...
  if (!createResult.HasMember("success") ||
      !createResult["success"].GetBool() || !createResult.HasMember("data") ||
      !createResult["data"].IsObject() ||
...
JSON_DOCUMENT Docker::execStart(const JSON_DOCUMENT &parameters,
