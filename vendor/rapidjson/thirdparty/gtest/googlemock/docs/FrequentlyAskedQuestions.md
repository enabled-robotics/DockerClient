...
In order for a method to be mocked, it must be _virtual_, unless you use the [high-perf dependency injection technique](thirdparty/gtest/googlemock/docs/CookBook.md#mocking-nonvirtual-methods).
...
[two](thirdparty/gtest/googlemock/docs/CookBook.md#writing-new-monomorphic-matchers)
[recipes](thirdparty/gtest/googlemock/docs/CookBook.md#writing-new-polymorphic-matchers)
...
[Here](thirdparty/gtest/googlemock/docs/ForDummies.md#using-google-mock-with-any-testing-framework) is how.
...
actions using
[MakeAction()](thirdparty/gtest/googlemock/docs/CookBook.md#writing-new-actions) or
[MakePolymorphicAction()](thirdparty/gtest/googlemock/docs/CookBook.md#writing_new_polymorphic_actions),
or you can write a stub function and invoke it using
[Invoke()](thirdparty/gtest/googlemock/docs/CookBook.md#using-functions_methods_functors).
...
See this [recipe](thirdparty/gtest/googlemock/docs/CookBook.md#mocking_side_effects) for more details and an example.
