...
[Google Test Primer](thirdparty/gtest/googletest/docs/primer.md) documentation.

**Google Mock** is an extension to Google Test for writing and using C++ mock
classes.  See the separate [Google Mock documentation](thirdparty/gtest/googlemock/README.md).

More detailed documentation for googletest (including build instructions) are
in its interior [googletest/README.md](thirdparty/gtest/googletest/README.md) file.
...
Please read the [`CONTRIBUTING.md`](thirdparty/gtest/CONTRIBUTING.md) for details on
